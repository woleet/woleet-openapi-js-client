...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Anchor', 'model/AnchorIds', 'model/Anchors', 'model/AuthorizedSignee', 'model/Credits', 'model/IdentityVerificationStatus', 'model/Receipt', 'model/ReceiptHeader', 'model/ReceiptSignature', 'model/ReceiptTarget', 'model/ReceiptTargetProofNode', 'model/ReceiptVerificationStatus', 'model/SignatureRequest', 'model/SignatureRequestSign', 'model/SignatureRequestSignResult', 'model/SignatureRequests', 'model/Token', 'model/X500Name', 'model/X509SubjectIssuer', 'api/AnchorApi', 'api/ReceiptApi', 'api/SignatureRequestApi', 'api/TokenApi', 'api/UserApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Anchor'), require('./model/AnchorIds'), require('./model/Anchors'), require('./model/AuthorizedSignee'), require('./model/Credits'), require('./model/IdentityVerificationStatus'), require('./model/Receipt'), require('./model/ReceiptHeader'), require('./model/ReceiptSignature'), require('./model/ReceiptTarget'), require('./model/ReceiptTargetProofNode'), require('./model/ReceiptVerificationStatus'), require('./model/SignatureRequest'), require('./model/SignatureRequestSign'), require('./model/SignatureRequestSignResult'), require('./model/SignatureRequests'), require('./model/Token'), require('./model/X500Name'), require('./model/X509SubjectIssuer'), require('./api/AnchorApi'), require('./api/ReceiptApi'), require('./api/SignatureRequestApi'), require('./api/TokenApi'), require('./api/UserApi'));
  }
}(function(ApiClient, Anchor, AnchorIds, Anchors, AuthorizedSignee, Credits, IdentityVerificationStatus, Receipt, ReceiptHeader, ReceiptSignature, ReceiptTarget, ReceiptTargetProofNode, ReceiptVerificationStatus, SignatureRequest, SignatureRequestSign, SignatureRequestSignResult, SignatureRequests, Token, X500Name, X509SubjectIssuer, AnchorApi, ReceiptApi, SignatureRequestApi, TokenApi, UserApi) {
  'use strict';

  /**
   * _BasicsThe_Woleet_API_is_an_HTTP_REST_API__It_supports_CORS_and_provides_Basic_authentication_and_JWT_authentication_allowing_an_easy_and_secure_interaction_with_both_web_clients_and_backend_applications_The_Woleet_API_is_specified_following_the__SwaggerOpenAPI_httpsopenapis_org_standard__You_can_get_the_specification_file_at_httpsapi_woleet_ioswagger_yaml_and_from_it_generate_client_code_for_most_languages_using_the__Swagger_Editor_httpeditor_swagger_ioimporthttpsapi_woleet_iov1swagger_json_or__Swagger_Codegen_httpswagger_ioswagger_codegen_Ready_to_use_versions_of_the_client_code_are_provided_as_open_source_code_for__JavaScriptNodeJS_httpsgithub_comwoleetwoleet_openapi_js_client_and__Java_httpsgithub_comwoleetwoleet_openapi_java_client_The_API_base_URL_is_httpsapi_woleet_iov1__AuthenticationThe_Woleet_API_provides__Basic_authentication_httpsen_wikipedia_orgwikiBasic_access_authentication_over_HTTPS_use_your_email_and_password_to_authenticate_The_Woleet_API_also_provides__JWT_authentication_httpsjwt_io_generate_a_JWT_token_by_doing_a_GET_call_on_the_token_endpoint__using_Basic_authentication_and_then_provide_this_token_to_subsequent_API_calls_in_the_Authorization_header_using_the_Bearer_scheme__PurposeThe_Woleet_API_provides_an_easy_and_cheap_way_to_create_timestamped_proofs_of_existence_and_timestamped_proofs_of_signature_for_your_data__which_can_be_of_any_type__Proofs_created_are_stored_in_the_Bitcoin_blockchain_and_so_are_independent_from_Woleet__an_access_to_the_Bitcoin_blockchain_and_some_client_side_open_source_code_is_enough_to_verify_proofs__Using_the_Woleet_API_you_can_create_durable_and_unfalsifiable_cryptographic_proofs_usable_to_prove_your_data_existed_in_a_given_state_at_a_given_date_and_optionally_was_signed_by_a_given_signee_The_Woleet_API_creates_proofs_of_existence_conform_to_the_open_source_standard__ChainPoint_httpswww_chainpoint_org__Consequently_they_can_be_verified_using_any_tool_compatible_with_this_standard_without_any_interaction_with_Woleet_and_so_remain_verifiable_forever_even_if_Woleet_stops_its_operations_The_Woleet_API_creates_proofs_of_signature_that_are_an_extension_of_the_same_standard_proposed_by_Woleet__we_are_actively_involved_in_the_standardization_process__Thus_the_existence_and_timestamp_of_a_signature_is_verifiable_using_the_same_tools_used_to_verify_proofs_of_existence__When_it_comes_to_verifying_the_validity_of_the_signature_and_the_signees_identity_some_additional_processing_is_performed_since_this_processing_can_be_fully_performed_client_side_with_no_additional_data_proofs_of_signature_remain_verifiable_forever_even_if_Woleet_stops_its_operations__Creating_proofsTo_create_a_proof_of_existence_for_a_file_you_need_to_create_what_we_call_an_anchor__An_anchor_is_basically_a_proof_of_existence_creation_request__To_do_so_you_only_need_to_compute_the_SHA256_hash_of_the_file_client_side_and_choose_a_name_for_the_anchor__Since_the_platform_doesnt_need_the_actual_file_there_is_no_limitation_on_the_size_or_on_the_type_of_the_file_and_the_file_is_not_even_leaked_to_Woleet_To_create_a_proof_of_signature_for_a_file_you_also_need_to_create_an_anchor_and_so_to_compute_the_SHA256_hash_of_the_file_and_choose_a_name_for_the_anchor_but_some_additional_data_is_required_your_public_key__the_one_associated_with_the_private_key_used_to_sign_the_SHA256_hash_of_the_file_and_your_signature_itself__Optionally_you_can_provide_a_URL_allowing_to_verify_your_identity_by_ensuring_you_own_the_public_key_and_the_TLS_certificate_of_the_URL_Newly_created_anchors_are_automatically_collected_by_the_platform_and_recorded_in_the_Bitcoin_blockchain_this_can_take_from_10_mn_to_a_few_hours_depending_on_the_load_the_the_Bitcoin_network_and_the_level_of_priority_of_your_user_account__To_check_the_state_of_your_anchors_you_can_pull_them_using_the_Woleet_API_or_you_can_associate_a_URL_to_an_anchor_that_the_platform_will_call_whenever_the_anchor_status_changes_Once_an_anchor_is_recorded_in_the_Bitcoin_blockchain_you_can_retrieve_its_associated_proof_receipt_using_the_Woleet_API__Proof_receipts_conform_to_the__ChainPoint_httpswww_chainpoint_org_standard_receipt_format__with_some_extension_when_it_comes_to_proofs_of_signature__The_proof_receipt_is_the_only_piece_of_data_required_to_prove_the_existencesignature_of_a_file_at_a_given_date__obviously_the_file_itself_is_also_required_since_it_is_not_included_in_the_proof_receipt__Thus_it_is_highly_recommended_you_keep_your_proof_receipts__and_your_files_in_your_own_data_store_so_that_you_dont_depend_on_the_Woleet_API_to_generate_the_proof_receipt_on_demand_whenever_you_want_to_verify_a_file__Verifying_proofsVerifying_a_proof_of_existence_using_the_Woleet_API_is_straightforward_the_API_takes_care_of_verifying_that_the_proof_receipt_is_valid_and_correctly_anchored_in_a_Bitcoin_transaction_so_you_just_need_to_check_that_the_SHA256_hash_of_the_file_matches_the_proof_receipts_hash_property_Verifying_a_proof_of_signature_using_the_Woleet_API_is_also_straightforward_the_API_takes_care_of_verifying_that_the_proof_receipt_is_valid_and_correctly_anchored_in_a_Bitcoin_transaction_then_verifies_the_signature_and_optionally_verifies_that_the_signee_owns_the_public_key_and_the_TLS_certificate_so_you_just_need_to_check_that_the_SHA256_hash_of_the_file_matches_the_proof_receipts_signedHash_property_The_Woleet_API_can_also_be_used_to_verify_any_ChainPoint_standard_receipts_including_the_ones_created_by_other_providers_Woleet_also_provides_an_open_source__JavaScript_library_for_web_clients_httpsgithub_comwoleetwoleet_weblibs_implementing_the_full_verification_process_without_the_help_of_the_Woleet_API__About_public_and_private_anchorsAn_anchor_can_be_public__which_is_the_default_or_private_A_private_anchor_is_only_discoverable_by_its_owner__see_the_anchors_endpoint__Thus_the_owner_needs_to_provide_the_proof_receipt_and_the_data_to_anyone_wanting_to_verify_the_proof_A_public_anchor_is_discoverable_by_anyone_knowing_the_hash_of_the_data__including_people_with_no_Woleet_account_see_the_anchorids_endpoint__This_allows_anyone_to_retrieve_the_proof_receipt_using_only_the_data_hash_as_input_and_then_to_verify_it_using_the_Woleet_API_or_any_other_mean__use_the_anchorids_endpoint_to_retrieve_the_anchor_identifier_by_its_hash__use_the_receiptanchorid_endpoint_to_retrieve_the_proof_receipt___use_the_receiptverify_endpoint__or_any_other_Chainpoint_compatible_tool_to_verify_the_proof_receipt_and_get_the_data_or_signature_timestamp__About_the_verification_processFor_your_understanding_here_is_a_formal_description_of_the_verification_process_of_a_proof_of_existence__compute_the_SHA256_hash_of_the_file__check_that_the_target_hash_property_of_the_proof_receipt_matches_the_hash_of_the_file__check_that_the_target_proof_property_of_the_proof_receipt_is_a_valid_Merkle_proof__see_the__ChainPoint_httpswww_chainpoint_org_standard_for_this_step__retrieve_the_Bitcoin_transaction_matching_the_tx_id_property_of_the_proof_receipt__check_that_the_OP_RETURN_field_of_the_Bitcoin_transaction_matches_the_merkle_root_property_of_the_proof_receiptFor_proof_of_signature_an_additional_verification_process_is_performed__check_that_the_SHA256_hash_of_the_signature_property_matches_its_target_hash_property__check_that_the_signature_property_is_a_valid_signature_of_the_signedHash_property_for_the_public_key_stored_in_the_pubKey_property__additionally_if_an_identityURL_property_is_available____call_identityURL_to_make_the_callee_sign_some_random_data_using_the_public_key_pubKey____check_that_the_returned_signature_is_valid____get_the_TLS_certificates_of_the_URL__it_must_be_an_HTTPS_URL_to_get_insight_about_the_signees_identity.<br>
