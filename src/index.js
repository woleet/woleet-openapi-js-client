...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Anchor', 'model/AnchorIds', 'model/Anchors', 'model/AuthorizedSignee', 'model/Credits', 'model/IdentityVerificationStatus', 'model/OtsReceipt', 'model/Receipt', 'model/ReceiptAnchorsNode', 'model/ReceiptHeader', 'model/ReceiptProofNode', 'model/ReceiptSignature', 'model/ReceiptTarget', 'model/ReceiptTargetProofNode', 'model/ReceiptVerificationStatus', 'model/SignatureRequest', 'model/SignatureRequestSign', 'model/SignatureRequestSignResult', 'model/SignatureRequests', 'model/Token', 'model/Tokens', 'model/User', 'model/Users', 'model/X500Name', 'model/X509SubjectIssuer', 'api/AnchorApi', 'api/DomainApi', 'api/ReceiptApi', 'api/SignatureRequestApi', 'api/TokenApi', 'api/UserApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Anchor'), require('./model/AnchorIds'), require('./model/Anchors'), require('./model/AuthorizedSignee'), require('./model/Credits'), require('./model/IdentityVerificationStatus'), require('./model/OtsReceipt'), require('./model/Receipt'), require('./model/ReceiptAnchorsNode'), require('./model/ReceiptHeader'), require('./model/ReceiptProofNode'), require('./model/ReceiptSignature'), require('./model/ReceiptTarget'), require('./model/ReceiptTargetProofNode'), require('./model/ReceiptVerificationStatus'), require('./model/SignatureRequest'), require('./model/SignatureRequestSign'), require('./model/SignatureRequestSignResult'), require('./model/SignatureRequests'), require('./model/Token'), require('./model/Tokens'), require('./model/User'), require('./model/Users'), require('./model/X500Name'), require('./model/X509SubjectIssuer'), require('./api/AnchorApi'), require('./api/DomainApi'), require('./api/ReceiptApi'), require('./api/SignatureRequestApi'), require('./api/TokenApi'), require('./api/UserApi'));
  }
}(function(ApiClient, Anchor, AnchorIds, Anchors, AuthorizedSignee, Credits, IdentityVerificationStatus, OtsReceipt, Receipt, ReceiptAnchorsNode, ReceiptHeader, ReceiptProofNode, ReceiptSignature, ReceiptTarget, ReceiptTargetProofNode, ReceiptVerificationStatus, SignatureRequest, SignatureRequestSign, SignatureRequestSignResult, SignatureRequests, Token, Tokens, User, Users, X500Name, X509SubjectIssuer, AnchorApi, DomainApi, ReceiptApi, SignatureRequestApi, TokenApi, UserApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The OtsReceipt model constructor.
     * @property {module:model/OtsReceipt}
     */
    OtsReceipt: OtsReceipt,
    /**
