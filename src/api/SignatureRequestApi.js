...
export default class SignatureRequestApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the feedbackSignatureRequest operation.
     * @callback module:api/SignatureRequestApi~feedbackSignatureRequestCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SignatureRequestApi~feedbackSignatureRequestCallback} callback The callback function, accepting three arguments: error, data, response
     */
    feedbackSignatureRequest(requestId, feedback, callback) {
      let postBody = feedback;
      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
        throw new Error("Missing the required parameter 'requestId' when calling feedbackSignatureRequest");
      }
      // verify the required parameter 'feedback' is set
      if (feedback === undefined || feedback === null) {
        throw new Error("Missing the required parameter 'feedback' when calling feedbackSignatureRequest");
      }
