...
export default class SignatureRequestApi {
    ...
    */
     ...
     */
    delegateSignSignatureRequest(requestId, delegate, callback) {
      ...
      if (delegate === undefined || delegate === null) {
        throw new Error("Missing the required parameter 'delegate' when calling delegateSignSignatureRequest");
      }
     ...
     * @param {String} requestId Identifier of the signature request.
     * @param {module:model/SignatureRequestEvent} event Event to report.
     ...
     */
    reportSignatureRequestEvent(requestId, event, callback) {
      let postBody = event;
      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
      ...
      if (event === undefined || event === null) {
        throw new Error("Missing the required parameter 'event' when calling reportSignatureRequestEvent");
      }
