...
(function(root, factory) {
   ...
   * @param targetProof {Array.<module:model/ReceiptTargetProofNode>} 
   */
  var exports = function(targetHash, targetURI, targetProof) {
    var _this = this;

    _this['target_hash'] = targetHash;
    _this['target_URI'] = targetURI;
    _this['target_proof'] = targetProof;
  };
   ...
   */
  exports.prototype['target_URI'] = undefined;
  /**
