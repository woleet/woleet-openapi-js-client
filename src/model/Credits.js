...
class Credits {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sealCredits')) {
                obj['sealCredits'] = ApiClient.convertToType(data['sealCredits'], 'Number');
            }
 ...
 * @member {Number} sealCredits
 */
Credits.prototype['sealCredits'] = undefined;
