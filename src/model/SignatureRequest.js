...
class SignatureRequest {
     ...
     * @param hashToSign {String} SHA256 hash (ie. the fingerprint) of the file to sign.<br> The value must be provided as an hexadecimal lowercase string. The hash of the empty file is forbidden.<br> 
     */
