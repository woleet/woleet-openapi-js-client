...
class User {
     ...
     * @param status {module:model/User.StatusEnum} The status of the user:<br> - PENDING: the user email needs to be validated<br> - APPROVED: the user can loging<br> - DISABLED: the user cannot login 
     */
