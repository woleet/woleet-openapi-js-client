...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WoleetApi.ReceiptExtraNode = factory(root.WoleetApi.ApiClient);
  }
  ...
  /**
   * The ReceiptExtraNode model module.
   * @module model/ReceiptExtraNode
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>ReceiptExtraNode</code>.
   * @alias module:model/ReceiptExtraNode
   * @class
   */
  ...
  /**
   * Constructs a <code>ReceiptExtraNode</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReceiptExtraNode} obj Optional instance to populate.
   * @return {module:model/ReceiptExtraNode} The populated <code>ReceiptExtraNode</code> instance.
   */
