...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReceiptHeader', 'model/ReceiptSignature', 'model/ReceiptTarget'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReceiptHeader'), require('./ReceiptSignature'), require('./ReceiptTarget'));
  } else {
    // Browser globals (root is window)
    if (!root.WoleetApi) {
      root.WoleetApi = {};
    }
    root.WoleetApi.Receipt = factory(root.WoleetApi.ApiClient, root.WoleetApi.ReceiptHeader, root.WoleetApi.ReceiptSignature, root.WoleetApi.ReceiptTarget);
  }
}(this, function(ApiClient, ReceiptHeader, ReceiptSignature, ReceiptTarget) {
  'use strict';
