...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReceiptExtraNode', 'model/ReceiptHeader', 'model/ReceiptTarget'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReceiptExtraNode'), require('./ReceiptHeader'), require('./ReceiptTarget'));
  } else {
    // Browser globals (root is window)
    if (!root.WoleetApi) {
      root.WoleetApi = {};
    }
    root.WoleetApi.Receipt = factory(root.WoleetApi.ApiClient, root.WoleetApi.ReceiptExtraNode, root.WoleetApi.ReceiptHeader, root.WoleetApi.ReceiptTarget);
  }
}(this, function(ApiClient, ReceiptExtraNode, ReceiptHeader, ReceiptTarget) {
  'use strict';
