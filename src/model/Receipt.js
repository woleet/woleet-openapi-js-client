...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReceiptExtraNode', 'model/ReceiptHeader', 'model/ReceiptSignature', 'model/ReceiptTarget'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReceiptExtraNode'), require('./ReceiptHeader'), require('./ReceiptSignature'), require('./ReceiptTarget'));
  } else {
    // Browser globals (root is window)
    if (!root.WoleetApi) {
      root.WoleetApi = {};
    }
    root.WoleetApi.Receipt = factory(root.WoleetApi.ApiClient, root.WoleetApi.ReceiptExtraNode, root.WoleetApi.ReceiptHeader, root.WoleetApi.ReceiptSignature, root.WoleetApi.ReceiptTarget);
  }
}(this, function(ApiClient, ReceiptExtraNode, ReceiptHeader, ReceiptSignature, ReceiptTarget) {
  'use strict';
   ...
   * @class
   * @param header {module:model/ReceiptHeader} 
   * @param target {module:model/ReceiptTarget} 
   */
  var exports = function(header, target) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('extra')) {
        obj['extra'] = ApiClient.convertToType(data['extra'], [ReceiptExtraNode]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ReceiptExtraNode>} extra
   */
