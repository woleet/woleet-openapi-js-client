...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WoleetApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.woleet.io/v1
     */
    this.basePath = 'https://api.woleet.io/v1'.replace(/\/+$/, '');
    ...
    this.authentications = {
      ...
      'JWTAuth': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
    };
    /**
