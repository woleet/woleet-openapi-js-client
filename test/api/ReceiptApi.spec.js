...
(function(root, factory) {
  ...
  describe('ReceiptApi', function() {
    describe('getOTSReceipt', function() {
      it('should call getOTSReceipt successfully', function(done) {
        //uncomment below and update the code to test getOTSReceipt
        //instance.getOTSReceipt(function(error) {
