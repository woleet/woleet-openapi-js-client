...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WoleetApi.ReceiptTarget();
  });
  ...
  describe('ReceiptTarget', function() {
    it('should create an instance of ReceiptTarget', function() {
      // uncomment below and update the code to test ReceiptTarget
      //var instane = new WoleetApi.ReceiptTarget();
      //expect(instance).to.be.a(WoleetApi.ReceiptTarget);
    });

    it('should have the property targetHash (base name: "target_hash")', function() {
      // uncomment below and update the code to test the property targetHash
      //var instane = new WoleetApi.ReceiptTarget();
      //expect(instance).to.be();
    });

    it('should have the property targetProof (base name: "target_proof")', function() {
      // uncomment below and update the code to test the property targetProof
      //var instane = new WoleetApi.ReceiptTarget();
      //expect(instance).to.be();
    });
