...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WoleetApi.ReceiptExtraNode();
  });
  ...
  describe('ReceiptExtraNode', function() {
    it('should create an instance of ReceiptExtraNode', function() {
      // uncomment below and update the code to test ReceiptExtraNode
      //var instane = new WoleetApi.ReceiptExtraNode();
      //expect(instance).to.be.a(WoleetApi.ReceiptExtraNode);
    });
