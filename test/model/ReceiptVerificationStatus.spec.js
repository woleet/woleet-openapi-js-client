...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WoleetApi.ReceiptVerificationStatus();
  });
  ...
  describe('ReceiptVerificationStatus', function() {
    it('should create an instance of ReceiptVerificationStatus', function() {
      // uncomment below and update the code to test ReceiptVerificationStatus
      //var instane = new WoleetApi.ReceiptVerificationStatus();
      //expect(instance).to.be.a(WoleetApi.ReceiptVerificationStatus);
    });
    ...
    it('should have the property identityVerificationStatus (base name: "identityVerificationStatus")', function() {
      // uncomment below and update the code to test the property identityVerificationStatus
      //var instane = new WoleetApi.ReceiptVerificationStatus();
      //expect(instance).to.be();
    });
