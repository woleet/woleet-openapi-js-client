...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WoleetApi.CallbackSecret();
  });
  ...
  describe('CallbackSecret', function() {
    it('should create an instance of CallbackSecret', function() {
      // uncomment below and update the code to test CallbackSecret
      //var instance = new WoleetApi.CallbackSecret();
      //expect(instance).to.be.a(WoleetApi.CallbackSecret);
    });
