...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WoleetApi.AnchorIds();
  });
  ...
  describe('AnchorIds', function() {
    it('should create an instance of AnchorIds', function() {
      // uncomment below and update the code to test AnchorIds
      //var instane = new WoleetApi.AnchorIds();
      //expect(instance).to.be.a(WoleetApi.AnchorIds);
    });
