...
*WoleetApi.SignatureRequestApi* | [**feedbackSignatureRequest**](docs/SignatureRequestApi.md#feedbackSignatureRequest) | **POST** /signatureRequest/{requestId}/feedback | Report feedback about a signature request.
