...
*WoleetApi.UserApi* | [**getTokens**](docs/UserApi.md#getTokens) | **GET** /user/tokens | Get user&#39;s tokens.
*WoleetApi.UserApi* | [**putTokens**](docs/UserApi.md#putTokens) | **PUT** /user/tokens | Update user&#39;s tokens.
...
## Documentation for Models
 ...
 - [WoleetApi.OtsReceipt](docs/OtsReceipt.md)
